...
add wave -noupdate -label reset /tb_AddSub_N/reset
...
add wave -noupdate /tb_AddSub_N/s_iC
add wave -noupdate /tb_AddSub_N/s_X
add wave -noupdate /tb_AddSub_N/s_Y
...
add wave -noupdate /tb_AddSub_N/s_S
add wave -noupdate /tb_AddSub_N/s_oC
add wave -noupdate /tb_AddSub_N/s_oF
